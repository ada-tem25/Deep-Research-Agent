...
#This file showcases some prompt engineering best practices, like defining the model’s role, specifying constraints, providing an example for illustration, etc.
#I should refer to it for future models!
...
- If the question has a very trivial answer, you can produce 0 query and directly answer it. 
